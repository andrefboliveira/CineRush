...
public class Estreia {
	...
	public Estreia(int numeroFilme, Element element) {
		this.numeroEstreia = numeroFilme;
	...
	public int getNumeroEstreia() {
		return numeroEstreia;
	}


	public void setNumeroEstreia(int numeroEstreia) {
		this.numeroEstreia = numeroEstreia;
	}
